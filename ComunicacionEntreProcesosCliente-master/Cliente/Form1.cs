...
namespace Cliente
{
    public partial class Form1 : Form
    {
        ...
        private void btnEnviarMensaje_Click(object sender, EventArgs e)
        {
            ...
            //para conexion local cambiar la ip del adaptador conectado ya sea lan o wifi
            ConexionCliente cc = new ConexionCliente("192.168.1.2", 6400);
            cc.inicioSocket();
        ...
        private void btnServidor2_Click(object sender, EventArgs e)
        {
            ...
            //ConexionCliente cc = new ConexionCliente("192.168.1.4", 6400);
            ConexionCliente cc = new ConexionCliente("192.168.1.4", 6400);
